      ...
      module.exports = function $$$reconciler($$$hostConfig) {
        ...
        function readContext(context2) {
          ...
          if (lastFullyObservedContext === context2) ;
            ...
            var contextItem = { context: context2, memoizedValue: value, next: null };
        ...
        function pushStoreConsistencyCheck(fiber, getSnapshot, renderedSnapshot) {
          ...
          var check = { getSnapshot, value: renderedSnapshot };
        ...
        var InvalidNestedHooksDispatcherOnRerenderInDEV = null;
        {
          ...
          HooksDispatcherOnMountInDEV = { readContext: function(context2) {
          ...
          HooksDispatcherOnMountWithHookTypesInDEV = { readContext: function(context2) {
            return readContext(context2);
          }, useCallback: function(callback, deps) {
            currentHookNameInDev = "useCallback";
            updateHookTypesDev();
          ...
          HooksDispatcherOnUpdateInDEV = { readContext: function(context2) {
            return readContext(context2);
          }, useCallback: function(callback, deps) {
            currentHookNameInDev = "useCallback";
            updateHookTypesDev();
          ...
          HooksDispatcherOnRerenderInDEV = { readContext: function(context2) {
            return readContext(context2);
          }, useCallback: function(callback, deps) {
            currentHookNameInDev = "useCallback";
            updateHookTypesDev();
          ...
          InvalidNestedHooksDispatcherOnMountInDEV = { readContext: function(context2) {
          ...
          InvalidNestedHooksDispatcherOnUpdateInDEV = { readContext: function(context2) {
            warnInvalidContextAccess();
            return readContext(context2);
          }, useCallback: function(callback, deps) {
            currentHookNameInDev = "useCallback";
          ...
          InvalidNestedHooksDispatcherOnRerenderInDEV = { readContext: function(context2) {
            warnInvalidContextAccess();
            return readContext(context2);
          }, useCallback: function(callback, deps) {
            currentHookNameInDev = "useCallback";
        ...
        function updateOffscreenComponent(current2, workInProgress2, renderLanes2) {
          ...
          if (nextProps.mode === "hidden" || enableLegacyHidden) {
            if ((workInProgress2.mode & ConcurrentMode) === NoMode) {
              var nextState = { baseLanes: NoLanes, cachePool: null };
              ...
              var _nextState = { baseLanes: nextBaseLanes, cachePool: spawnedCachePool };
              workInProgress2.memoizedState = _nextState;
              workInProgress2.updateQueue = null;
              pushRenderLanes(workInProgress2, nextBaseLanes);
              return null;
            } else {
              var _nextState2 = { baseLanes: NoLanes, cachePool: null };
        ...
        function updateHostRoot(current2, workInProgress2, renderLanes2) {
          ...
          if (supportsHydration && prevState.isDehydrated) {
            var overrideState = { element: nextChildren, isDehydrated: false, cache: nextState.cache, transitions: nextState.transitions };
            var updateQueue = workInProgress2.updateQueue;
        ...
        function updateSuspenseOffscreenState(prevOffscreenState, renderLanes2) {
          var cachePool = null;
          return { baseLanes: mergeLanes(prevOffscreenState.baseLanes, renderLanes2), cachePool };
        }
        ...
        var reporter = { onError: function(error3) {
          hasError = true;
          caughtError = error3;
        } };
...
function createRoot(canvas) {
  ...
  return {
    ...
    render(children) {
      ...
      reconciler.updateContainer((0, import_jsx_runtime.jsx)(SceneObject, {
        store,
        children,
        onCreated,
        rootElement: canvas,
...
function Provider({
  ...
  return (0, import_jsx_runtime.jsx)(SceneObject, {
    value: store,
    children,
...
function Portal({
  ...
  return (0, import_jsx_runtime.jsx)(SceneObject, {
    children: reconciler.createPortal((0, import_jsx_runtime.jsx)(SceneObject, {
    ...
    __component: import_jsx_runtime.Fragment,
    __meta: {
      "path": "",
      "name": "unknown",
      "line": -2,
...
var FiberProvider = class extends React2.Component {
  render() {
    return React2.createElement(SceneObject, {
      ...{
...
function useContextBridge() {
  ...
  return React2.useMemo(() => Array.from(contextMap.keys()).reduce((Prev, context2) => (props) => React2.createElement(SceneObject, {
    ...null,
    __component: Prev,
    __meta: {
      "path": "",
  ...
  }, React2.createElement(SceneObject, {
    ...__spreadProps(__spreadValues({}, props), {
      value: contextMap.get(context2)
    }),
    __component: context2.Provider,
    __meta: {
      "path": "",
      "name": "unknown",
      "line": -2,
  ...
  })), (props) => React2.createElement(SceneObject, {
...
var CanvasImpl = React3.forwardRef(function Canvas({
  ...
  useIsomorphicLayoutEffect2(() => {
    ...
    if (containerRect.width > 0 && containerRect.height > 0 && canvas) {
      ...
      root.current.render((0, import_jsx_runtime2.jsx)(SceneObject, {
        children: (0, import_jsx_runtime2.jsx)(SceneObject, {
          set: setError,
          children: (0, import_jsx_runtime2.jsx)(SceneObject, {
            fallback: (0, import_jsx_runtime2.jsx)(SceneObject, {
              set: setBlock,
              __component: Block,
              __meta: {
                "path": "",
  ...
  return (0, import_jsx_runtime2.jsx)(SceneObject, {
    ref: divRef,
    style: {
      position: "relative",
      width: "100%",
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C6GLWXVO.js.map
