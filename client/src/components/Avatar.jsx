...
export function Avatar({
  ...
  const { animations: walkAnimations } = useGLTF("/animations/M_Walk_001.glb");
  const { animations: idleAnimations } = useGLTF(
    "/animations/M_Standing_Idle_001.glb",
  );
  const { animations: danceAnimations } = useGLTF(
    "/animations/M_Dances_004.glb",
  );

  const { actions } = useAnimations(
    [walkAnimations[0], idleAnimations[0], danceAnimations[0]],
    avatar,
  );
